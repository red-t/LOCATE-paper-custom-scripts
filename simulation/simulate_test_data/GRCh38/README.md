...
bash your_path_to/simulation/simulation_protocol.sh -d ./ -r your_path_to/GRCh38_no_alt.fa -t your_path_to/GRCh38.transposon.fa -N 100 -R 0 --sub-N 5 --germline-count 2500 --avg-somatic-count 0 --min-distance 9000 --depth 50 --species human --protocol ccs --truncProb 0.7 --nestProb 0 --mode 2

# 2. For Low-frequency Insertion Testing Datasets
mkdir testing_dataset_1 && cd testing_dataset_1
bash your_path_to/simulation/simulation_protocol.sh -d ./ -r your_path_to/GRCh38_no_alt.fa -t your_path_to/GRCh38.transposon.fa -N 1000 -R 0 --sub-N 50 --germline-count 0 --avg-somatic-count 10 --min-distance 9000 --depth 50 --species human --protocol ccs --truncProb 0.7 --nestProb 0 --mode 2
```
