...
#SBATCH --output=./logs/Merge/GRCh38/merge-log-GRCh38-%A-%a.out
...
################################
[ -z $FILELIST ] && FILELIST=your_path_to/simulation/simulate_test_data/GRCh38/filelist_examples/merge_filelist_GRCh38
[ -z $CONTIGS ] && CONTIGS=(`cut -f 1 your_path_to/GRCh38_no_alt.fa.fai`)
