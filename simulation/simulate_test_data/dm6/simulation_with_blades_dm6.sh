...
#SBATCH --output=./log/simulation-log-dm6-%A-%a.out
...
################################
[ -z $FILELIST ] && FILELIST=your_path_to/simulation/simulate_test_data/dm6/filelist_examples/simulation_filelist_dm6
