...
#SBATCH --mem=60G
#SBATCH -c 36
#SBATCH --array=1-50,251-300,401-450%20
...
################################
[ -z $FILELIST ] && FILELIST=your_path_to/simulation/simulate_training_data/GRCh38/filelist_examples/minimap2_filelist_GRCh38
