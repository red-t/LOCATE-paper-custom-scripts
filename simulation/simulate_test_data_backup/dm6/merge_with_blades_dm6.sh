...
#SBATCH --output=./logs/Merge/dm6/merge-log-dm6-%A-%a.out
...
################################
[ -z $FILELIST ] && FILELIST=your_path_to/simulation/simulate_test_data/dm6/filelist_examples/merge_filelist_dm6
