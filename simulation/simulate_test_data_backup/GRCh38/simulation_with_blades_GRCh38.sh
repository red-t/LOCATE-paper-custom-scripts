...
#SBATCH --mem=40G
#SBATCH -c 20
#SBATCH --array=1-138%6
#SBATCH --partition=5days
#SBATCH --output=./log/simulation-log-GRCh38-%A-%a.out
...
################################
[ -z $FILELIST ] && FILELIST=your_path_to/simulation/simulate_test_data/GRCh38/filelist_examples/simulation_filelist_GRCh38
...
PROG_PATH="your_path_to/simulation"
