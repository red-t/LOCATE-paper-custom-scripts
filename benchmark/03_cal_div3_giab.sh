...
# minimap2 -k11 -w5 --sr -O4,8 -n2 -m20 --secondary=no -t 1 -aY -x map-ont /zata/zippy/boxu/annotation/from_temp3/GRCh38.transposon.fa ${OUT_PATH}/${GENOME}.test3.fa > ${OUT_PATH}/${GENOME}.test3.sam 2>${OUT_PATH}/${GENOME}.test3.sam.log
