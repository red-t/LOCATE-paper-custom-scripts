...
OUT_PATH="${path2}/rawdata/simulation/hg38/new_ont_v2"   # "${path2}/simulation/result/"
[ ! -d ${OUT_PATH} ] && mkdir -p ${OUT_PATH}

ANNO_PATH="${path1}" #"${path1}"
GENOME_FA="${ANNO_PATH}/from_temp3/GRCh38_no_alt.fa"
...
## ont
cp ${path2}/TestingDataset/GRCh38/1_ont/TGS.fastq.gz ${OUT_PATH}/simulation_germ_ont.fastq.gz
