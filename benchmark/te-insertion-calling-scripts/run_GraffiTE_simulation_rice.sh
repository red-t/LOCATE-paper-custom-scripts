...
OUT_PATH_dir="${path2}/result/simulation/IRGSPv1"
...
TE_ANNO_FA2="${ANNO_PATH}/${GENOME}/${GENOME}.transposon.2.fa"
REPEATMASKER_FILE="${ANNO_PATH}/${GENOME}/${GENOME}.rmsk.bed"
REPEAT_CLASS="${ANNO_PATH}/${GENOME}/${GENOME}.transposon.class"
CHROM_LIST="${ANNO_PATH}/${GENOME}/${GENOME}.chrom.list"
library=${ANNO_PATH}/${GENOME}/${GENOME}.transposon.fa
...
for SAMPLE in simulation_germ_ccs # simulation_germ_ont simulation_germ_clr # simulation_germ_clr simulation_germ_ont # simulation_germ_ccs simulation_germ_clr simulation_germ_ont  # simulation_germ_clr ## simulation_soma_ont simulation_soma_clr simulation_soma_ccs #   # simulation_soma # HG001 # HG002 # SRR9685183.sra
do
    ...
    do
        ...
        echo "${DATA_PATH}/${GENOME}/tgs/${SAMPLE}.${depth}X.fa,${SAMPLE},${template_map_mode}" >> ${OUT_PATH}/GraffiTE/${SAMPLE}/longreads.csv
