...
OUT_PATH="${path2}/rawdata/simulation/dm6/new_ont_v2"   # "${path2}/simulation/result/"
...
## ont
cp ${path2}/TestingDataset/Dm6/1_ont/TGS.fastq.gz ${OUT_PATH}/simulation_germ_ont.fastq.gz
